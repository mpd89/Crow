Imports daqartDLL
Imports System.IO
Public Class WeldNDEPcntComplete
    ...
    Public Sub New(ByVal dt As DataTable, ByVal startDate As String, ByVal endDate As String, _
                    ByVal subHeading As String, ByVal logoPath As String)
    ...
    Private Sub WeldNDEPcntComplete_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try


            Me.ReportViewer1.RefreshReport()
            Dim ReportDataSource1 As Microsoft.Reporting.WinForms.ReportDataSource = New Microsoft.Reporting.WinForms.ReportDataSource
            Me.ReportViewer1.LocalReport.ReportEmbeddedResource = "ReportManager.WeldTrackingReport.rdlc"
            ...
            Dim eitems As New ReportManager.WeldTrackingItems
            For Each dr As DataRow In dt_DataSource.Rows
                Dim eitem As New ReportManager.WeldTrackingItem
        ...
        Catch ex As Exception
            Utilities.logErrorMessage("ReportManager.WeldNDEPcntComplete._Load-" + ex.Message)
